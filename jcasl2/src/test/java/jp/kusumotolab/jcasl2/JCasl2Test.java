...
public class JCasl2Test {
  ...
  public void bug3() throws Exception {
    Path casPath = Paths.get(JCasl2Test.class.getResource("/bug3.cas")
        .toURI());
  ...
  public void bug5() throws Exception {
    Path casPath = Paths.get(JCasl2Test.class.getResource("/bug5.cas")
        .toURI());
    Path inputPath = Paths.get(tmpDir.toString(), casPath.getFileName()
        .toString());
    Files.copy(casPath, inputPath, StandardCopyOption.REPLACE_EXISTING);
  ...
  public void bug6() throws Exception {
    Path casPath = Paths.get(JCasl2Test.class.getResource("/bug6.cas")
        .toURI());
    Path inputPath = Paths.get(tmpDir.toString(), casPath.getFileName()
        .toString());
    Files.copy(casPath, inputPath, StandardCopyOption.REPLACE_EXISTING);
  ...
  public void bug7() throws Exception {
    Path casPath = Paths.get(JCasl2Test.class.getResource("/bug7.cas")
        .toURI());
    Path inputPath = Paths.get(tmpDir.toString(), casPath.getFileName()
        .toString());
    Files.copy(casPath, inputPath, StandardCopyOption.REPLACE_EXISTING);
  ...
  private void test(String target) throws Exception {
    Path casPath = Paths.get(JCasl2Test.class.getResource("/enshud/" + target + ".cas")
        .toURI());
    Path comPath = Paths.get(JCasl2Test.class.getResource("/enshud/" + target + ".com")
        .toURI());
  ...
  public void testHelp() throws IOException {
    String actual = runJCasl2(new String[] {"-h"}).replace("\r", "");
    String expected = "Usage: JCasl2 [options] input.cas [output.com]\n"
        + "  -a           turn on verbose listings\n" + "  -v --version display version and exit\n";
    assertEquals(expected, actual);
  }

  private static String runJCasl2(String[] args) throws IOException {
